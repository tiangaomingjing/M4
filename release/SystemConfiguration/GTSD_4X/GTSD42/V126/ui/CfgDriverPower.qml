...
import QtClass 1.0
import "./components/CfgDriverPower"
...
Rectangle{
    ...
    function resetTextInputState(){
        vdc_up.resetbackground();
        vdc_down.resetbackground();
        softon_down.resetbackground();
        softon_up.resetbackground();
        brake_down.resetbackground();
        brake_up.resetbackground();
    }
...
////                       }
//                        function onTheTextChanged(){
//                            softon_down.textColor="red";factory.dataTree.setTopLevelText(5,1,softon_down.text);
//                        }
//                        Component.onCompleted: {
...
//        brake_down.textColor="black";
        ...
        driverPower.qmlEditUiStateChanged.connect(setEditSate);
    }
    Connections{
        target: driverPower;
        onItemValueChanged:{
