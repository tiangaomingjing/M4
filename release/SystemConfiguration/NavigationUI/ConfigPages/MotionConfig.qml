...
Item {
    ...
    Timer{
        ...
        property double currentCount: 0;
        property double totalCount: 500;
        onTriggered: {
            currentCount++;
            m_mainProgressBar.value=100/totalCount*currentCount;
    ...
    Timer{
        ...
        onTriggered: {
            ...
            circleTimeCount++;
            m_mainProgressBar.value=100/totalCicle*circleTimeCount;
                ...
                Rectangle{
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            m_mainProgressBar.value=0;
                            m_mainProgressBar.visible=true;//显示进度条
                            //周期循环运动
                            ...
                            //非周期运动
                                ...
                                mg_servoCmd.setServoOn(true);
                                mg_servoCmd.delayMs(500);
                                m_tryRunNoneCircleTimer.totalCount=delayTime*1000/10;
                                m_tryRunNoneCircleTimer.interval=10;//最小时基为10ms
                                m_tryRunNoneCircleTimer.repeat=true;
