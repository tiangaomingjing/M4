...
function getTypeId(){
    ...
    var typeIndex;
    modelIndex=m_treeModel.parent(m_tree.currentIndex);
    typeIndex=m_treeModel.parent(m_tree.currentIndex);
...
function updateUserConfig(){
    userConfigSrc.setTypeId(m_tree.m_configTypeId);
    userConfigSrc.setTypeName(m_tree.m_configTypeName);
    userConfigSrc.setModelName(m_tree.m_configModelName);
    userConfigSrc.setAxisCount(m_tree.m_configAxisCount);
    userConfigSrc.setVersion(m_tree.m_configVersion);
}
