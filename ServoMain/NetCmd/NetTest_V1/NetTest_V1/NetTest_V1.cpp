...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//gSevDrv.sev_obj.vel.ctl.prm.ti_fst_5
	id = -1;
	getIndex = 0;
	kgain = 100;
	cmd = 22;
	...
	//gSevDrv.sev_obj.vel.ctl.prm.fn_sec_5 
	func.cmd = 49;
	result = (COM_ERROR)GTSD_CMD_ProcessorGeneralFunc(5, &func, comType, 0xf0);

	//gSevDrv.sev_obj.vel.ctl.prm.ti_sec_5 
	func.cmd = 49;
	result = (COM_ERROR)GTSD_CMD_ProcessorGeneralFunc(5, &func, comType, 0xf0);

	//gSevDrv.sev_obj.pos.ctl.prm.fn_sec_6
	func.cmd = 50;
	result = (COM_ERROR)GTSD_CMD_ProcessorGeneralFunc(5, &func, comType, 0xf0);
	std::cout << result;
#endif
