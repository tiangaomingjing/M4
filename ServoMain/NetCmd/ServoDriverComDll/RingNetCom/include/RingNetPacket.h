...
const int32			RN_MAX_PACKET_LEN				= 490;							// 发送和接收数据buf的最大长度
...
//------------------------------------------------------------------------------
#define		RN_USER_PROTOCOL_DRIVER		0x00
//0x10                                                    
#define		RN_USER_PROTOCOL_MOTION		0x20                                                   
#define		RN_USER_PROTOCOL_PC			0x30
//////////////////////////////////////////////////////////////////////////
...
// typedef union
// {
// 	StRnAppPacketHeadAll	    all;
// 	StRnAppPacketHeadBits		bit;
// 
// }StRnUserPayloadHead;
...
// typedef union
// {
// 	StRnBaseControlAll	    all;
// 	StRnBaseControlBit		bit;
// 
// }StRnBaseControl;
...
typedef struct  
{
	...
	StRnBaseControl basecontrol;			// basecontrol;						// basecontrol [2:0]
	// PACKET_OFFSET_GEN = 0,
...
// 	Uint8 protocolType0;					// index用于去重复报文 0xFF开始自加
// 	Uint8 protocolType1;					// write 0xff
	StRnHeadFormat		ringnet_head;
//	StRnAppPacketHead	app_head;				// app packet header
	//header format end
	Uint8 dataSection[RN_MAX_PACKET_LEN];	// user data section 
...
public:
	...
	*******************************************************************************************/
	...
	int16 DecoderUserDriverPacket();
	int16 DecoderUserMotionPacket();
	/*******************************************************************************************
	功能：填充包中的数据
	*******************************************************************************************/
...
protected:
	void init_pack();
	inline Uint8 CalcCheckSum(RN_PACKET_FORMAT*	pRx);
};
