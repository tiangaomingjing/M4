...
#include ".\NetCom\include\Basetype_def.h"
...
{
	GTSD_COM_TYPE_NET,			//¬„ª˙Õ¯ø⁄
	GTSD_COM_TYPE_RNNET,		//µ»ª∑Õ¯
	GTSD_COM_TYPE_TCPIP,		//TCP/IP–≠“ÈÕ¯ø⁄
	GTSD_COM_TYPE_USB2UART,		//usb◊™¥Æø⁄
	GTSD_COM_TYPE_VIRTUAL,		//–Èƒ‚…Ë±∏
	GTSD_COM_TYPE_RINGNET,		//µ»ª∑Õ¯
	GTSD_COM_TYPE_MAX			//◊Ó¥Û÷µ
}COM_TYPE;
...
{
	Uint16			lenth;									//≥§∂»   (unit :byte)   
	Uint32			addr;									//µÿ÷∑      
	Uint16			type;									//º«¬º¿‡–Õ£¨0£≠ ˝æ›£¨1£≠÷’÷π     
	int16			data[INTEL_HEX_FRAME_DAT_LENTH];		// ˝æ›     
	int16			checksum;								//–£—È∫Õ 
}INTEL_HEX_FRAME;
