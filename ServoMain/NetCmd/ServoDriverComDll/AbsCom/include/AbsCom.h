...
//	CRnNetInterface*	m_pRnNetCom;
	CRingNetInterface*	m_pRnNetCom;
	CSocketInterface*   m_pSocketCom;
	CRingNetInterface*	m_pRingNetCom;
	...
	*******************************************************************************************/
	...
	返回：		0成功，其他参看错误列表。
	*******************************************************************************************/
	int16 GTSD_Com_Firmware_handler(int16 comType, int16 comMode, int16 comAddr, int16* pData, int16 comNum, int16 stationId, int16 needReq = RN_NEED_REQ);
	/*******************************************************************************************
