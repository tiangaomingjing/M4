...
// StImage::~StImage()
// {
// 	StChunk *c = first_chunk;
// 	while (c) {
// 		StChunk *next_c = c->next;
// 		delete c;
// 		c = next_c;
// 	}
// }
// 
// CRnSerialPort::CRnSerialPort()
// {
// 	status = FALSE;
// 	m_pMapping = NULL;
// 	m_pDriver = NULL;
...
// }
// 
// short CRnSerialPort::Initial(CRnServoAxiMapping* pMapping, CRingNetInterface* pDriver)
// {
// 	if (pMapping == NULL || pDriver == NULL)
// 	{
...
// 
// //////////////////////////////////////////////////////////////////////////
// short CRnSerialPort::open(int16 axis, int32 baudRate)
// {
...
// 
// 	//根据dsp号选择FPGA基地址
// 	Uint16 station_id = m_pMapping->ConvertDspToStationId(axis);
// 	int16 base_addr = m_pMapping->ConvertFpgaByteAddrByDspId(axis, FPGA_DSPA_UART_RNNET_BASEADDR);
// 
// 	//计算实际的地址
// 	int16 comAddr;
// 	int16 comAddr1;
...
// 	int16 rtn = m_pDriver->RnNetCom_FPGA_ComHandler(GTSD_COM_MODE_WRITE, comAddr2, &startValue, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return rtn;
// 	}
// 	//读取该值验证是否已经打开该模块
// 	int16 startVauleRtn;
// 	rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr3, &startVauleRtn, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return rtn;
// 	}
...
// 
// 	//配置停止位，奇偶校验，传输位宽等
// 	rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_WRITE, comAddr, &dl_cfg, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return false;
// 	}
// 	//读取配置进行验证
// 	int16 dl_cfg_rtn;
// 	rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr, &dl_cfg_rtn, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return false;
// 	}
...
// 	//----------------------------------------------------------------------------
// 	//配置波特率
// 	rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_WRITE, comAddr1, &dl_bd, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return false;
// 	}
// 	int16 dl_bd_rtn;
// 	rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr1, &dl_bd_rtn, comNum, station_id >> 8);
// 	if (rtn != RTN_SUCCESS)
// 	{
// 		return false;
// 	}
...
// }
// 
// short CRnSerialPort::close(int16 axis)
// {
// 	if (status == true)
// 	{
...
// 		int16 rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_WRITE, comAddr, &stopValue, comNum, station_id >> 8);
// 		if (rtn != RTN_SUCCESS)
// 		{
// 			return false;
// 		}
// 		//读取该值验证是否已经关闭该模块
// 		int16 stopValueRtn;
// 		rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr1, &stopValueRtn, comNum, station_id >> 8);
// 		if (rtn != RTN_SUCCESS)
// 		{
// 			return false;
// 		}
...
// }
// 
// short CRnSerialPort::read(int16 axis, Uint8 *buf, int32 length, int32 *length_read)
// {
...
// 		{
// 			//查询当前 rx fifo中有多少数据。
// 			rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr, &stateValue, comNum, station_id >> 8);
// 			if (rtn != RTN_SUCCESS)
// 			{
// 				return false;
// 			}
...
// 		for (i = 0; i < length; ++i)
// 		{
// 			rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr1, &tmp, comNum, station_id >> 8);
// 			if (rtn != RTN_SUCCESS)
// 			{
// 				return false;
// 			}
...
// }
// 
// short CRnSerialPort::write(int16 axis, Uint8 *buf, int32 length, int32 *length_written)
// {
...
// 		do
// 		{
// 			rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_READ, comAddr1, &stateValue, comNum, station_id >> 8);
// 			if (rtn != RTN_SUCCESS)
// 			{
// 				return false;
// 			}
...
// 			}
// 			rtn = m_pDriver->RnNetCom_FPGA_ComHandler( GTSD_COM_MODE_WRITE, comAddr2, buffer, comNum, station_id >> 8);
// 			if (rtn != RTN_SUCCESS)
// 			{
// 				return false;
// 			}
...
// }
// 
// short CRnSerialPort::downloadBootStream(int16 axis, string& inputKey, int16 cmd, string& filename, void(*tpfUpdataProgressPt)(void*, int16*), void* ptrv, int16& progress)
// {
// 	if (cmd == CRnSerialPort::AC_PROGRAM)
// 	{
// 		if (!send_ldr_img(axis, inputKey, filename, tpfUpdataProgressPt, ptrv, progress))
// 		{
// 			return false;
// 		}
...
// 		return true;
// 	}
// 	if (cmd == CRnSerialPort::AC_ERASE)
// 	{
// 		return send_erase_cmd(axis, tpfUpdataProgressPt, ptrv, progress);
// 	}
// 
// 	return false;
// }
...
// short CRnSerialPort::send_ldr_img(int16 axis, string& inputKey, string& filename, void(*tpfUpdataProgressPt)(void*, int16*), void* ptrv, int16& progress)
// {
// 	Uint8 key[16];
// 	//判断是否key存在
...
// 		return false;
// 
// 	unique_ptr<StImage> img(read_img(filename, 0, 0x80000000, 4));
// 	/*
...
// 			if ((write(axis, data + addr, to_write, (int32*)&written) != RTN_SUCCESS) || !written)
// 			{
// 				// Download failed;
// 				return false;
// 			}
...
// */
// int16 CRnSerialPort::parse_key(string& inputKey, Uint8 key[16])
// {
...
// StImage* CRnSerialPort::read_img(string& filename, Uint32 range_start, Uint32 range_len, Uint32 alignment)
// {
// 	FILE *file = NULL;
...
// 	}
// 
// 	StImage *img = new StImage(range_start, range_len, alignment);
// 
...
// }
// 
// int32 CRnSerialPort::pad(int32 len, int32 align)
// {
// 	return (len + (align - 1)) & (~(align - 1));
// }
// 
// short CRnSerialPort::do_autobaud(int16 axis, Uint8 c, Uint8 *buf, Uint32 len)
// {
// 	Uint32 written;
// 	short rtn = write(axis, &c, 1, (int32*)&written);
// 	if (rtn != RTN_SUCCESS || written != 1)
// 	{
// 		return rtn;
// 	}
...
// 
// 	Uint32 received;
// 	rtn = read(axis, read_buf, read_len, (int32*)&received);
// 	if (rtn != RTN_SUCCESS || !received)
// 	{
// 		return rtn;
// 	}
...
// }
// 
// short CRnSerialPort::do_ldr_autobaud(int16 axis)
// {
// 	Uint8 buf[4];
// 	if (!do_autobaud(axis, '@', buf, sizeof(buf)))
// 		return false;
// 
...
// }
// 
// short CRnSerialPort::send_erase_cmd(int16 axis, void(*tpfUpdataProgressPt)(void*, int16*), void* ptrv, int16& progress)
// {
// 	if (!do_ldr_autobaud(axis))
// 		return false;
// 
...
// 
// 	Uint32 written = 0;
// 	short rtn = write(axis, cmd, sizeof(cmd), (int32*)&written);
// 	if (rtn != RTN_SUCCESS || written != sizeof(cmd))
// 	{
// 		return RTN_SUCCESS;
// 	}
